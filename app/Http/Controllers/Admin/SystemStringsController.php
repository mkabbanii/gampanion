...
class SystemStringsController extends Controller
{
    public function index()
    {
        ...
        return view('admin.systemStrings.index', compact('systemStrings'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.systemStrings.create');
    }
    ...
    public function store(StoreSystemStringRequest $request)
    {
        ...
        return redirect()->route('admin.system-strings.index');
    }
    ...
    public function edit(SystemString $systemString)
    {
        ...
        return view('admin.systemStrings.edit', compact('systemString'));
    }
    ...
    public function show(SystemString $systemString)
    {
        ...
        return view('admin.systemStrings.show', compact('systemString'));
    }
