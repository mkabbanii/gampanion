...
class GampanionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.gampanions.index', compact('gampanions'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.gampanions.create', compact('games', 'users'));
    }
    ...
    public function store(StoreGampanionRequest $request)
    {
        ...
        return redirect()->route('frontend.gampanions.index');
    }
    ...
    public function edit(Gampanion $gampanion)
    {
        ...
        return view('frontend.gampanions.edit', compact('games', 'users', 'gampanion'));
    }
    ...
    public function show(Gampanion $gampanion)
    {
        ...
        return view('frontend.gampanions.show', compact('gampanion'));
    }
