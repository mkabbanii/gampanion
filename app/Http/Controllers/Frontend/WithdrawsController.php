...
class WithdrawsController extends Controller
{
    ...
    public function index()
    {
        ...
        $withdraws = Withdraw::with(['user', 'payment_method', 'status', 'media'])->get();

        return view('frontend.withdraws.index', compact('withdraws'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.withdraws.create', compact('users', 'payment_methods', 'statuses'));
    }
    ...
    public function store(StoreWithdrawRequest $request)
    {
        ...
        return redirect()->route('frontend.withdraws.index');
    }
    ...
    public function edit(Withdraw $withdraw)
    {
        ...
        return view('frontend.withdraws.edit', compact('users', 'payment_methods', 'statuses', 'withdraw'));
    }
    ...
    public function show(Withdraw $withdraw)
    {
        ...
        return view('frontend.withdraws.show', compact('withdraw'));
    }
