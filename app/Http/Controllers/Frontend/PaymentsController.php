...
class PaymentsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.payments.create', compact('users', 'statuses', 'payment_methods'));
    }
    ...
    public function edit(Payment $payment)
    {
        ...
        return view('frontend.payments.edit', compact('users', 'statuses', 'payment_methods', 'payment'));
    }
