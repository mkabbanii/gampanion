                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('games_and_order_access')
                                        <a class="dropdown-item disabled" href="#">
                                            {{ trans('cruds.gamesAndOrder.title') }}
                                        </a>
                                    @endcan
                                    @can('game_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.games.index') }}">
                                    ...
                                    @can('gampanion_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.gampanions.index') }}">
                                    ...
                                    @endcan
                                    @can('favorite_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.favorites.index') }}">
                                    ...
                                    @can('redemption_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.redemptions.index') }}">
                                            {{ trans('cruds.redemption.title') }}
                                        </a>
                                    @endcan
                                    ...
                                    @endcan
                                    @can('message_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.messages.index') }}">
                                            {{ trans('cruds.message.title') }}
                                        </a>
                                    @endcan
                                    @can('banner_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.banners.index') }}">
                                            {{ trans('cruds.banner.title') }}
                                        </a>
                                    @endcan
                                    @can('money_matter_access')
                                        <a class="dropdown-item disabled" href="#">
                                            {{ trans('cruds.moneyMatter.title') }}
                                        </a>
                                    @endcan
                                    @can('wallet_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.wallets.index') }}">
                                    ...
                                    @endcan
                                    @can('withdraw_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.withdraws.index') }}">
                                    ...
                                    @can('system_string_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.system-strings.index') }}">
                                            {{ trans('cruds.systemString.title') }}
                                        </a>
                                    @endcan
