                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.wallets.update", [$wallet->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('balance') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="balance" id="balance" value="{{ old('balance', $wallet->balance) }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('previous_balance') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="previous_balance" id="previous_balance" value="{{ old('previous_balance', $wallet->previous_balance) }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('last_added_amount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="last_added_amount" id="last_added_amount" value="{{ old('last_added_amount', $wallet->last_added_amount) }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('last_deduct_amount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="last_deduct_amount" id="last_deduct_amount" value="{{ old('last_deduct_amount', $wallet->last_deduct_amount) }}" step="1">
