                    ...
                    <form method="POST" action="{{ route("admin.coupons.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('is_valid') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Coupon::IS_VALID_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="is_valid_{{ $key }}" name="is_valid" value="{{ $key }}" {{ old('is_valid', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('end_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="end_date" id="end_date" value="{{ old('end_date') }}" required>
