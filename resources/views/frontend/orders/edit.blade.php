                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.orders.update", [$order->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="game_id" id="game_id">
                                @foreach($games as $id => $game)
                                    <option value="{{ $id }}" {{ (old('game_id') ? old('game_id') : $order->game->id ?? '') == $id ? 'selected' : '' }}>{{ $game }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('game'))
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="status_id" id="status_id" required>
                                @foreach($statuses as $id => $status)
                                    <option value="{{ $id }}" {{ (old('status_id') ? old('status_id') : $order->status->id ?? '') == $id ? 'selected' : '' }}>{{ $status }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount_deducted_from_user" id="amount_deducted_from_user" value="{{ old('amount_deducted_from_user', $order->amount_deducted_from_user) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount_earned_by_provider" id="amount_earned_by_provider" value="{{ old('amount_earned_by_provider', $order->amount_earned_by_provider) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="note" id="note" value="{{ old('note', $order->note) }}">
                            @if($errors->has('note'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('note') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="gampanion_id" id="gampanion_id" required>
                                @foreach($gampanions as $id => $gampanion)
                                    <option value="{{ $id }}" {{ (old('gampanion_id') ? old('gampanion_id') : $order->gampanion->id ?? '') == $id ? 'selected' : '' }}>{{ $gampanion }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="approved_at" id="approved_at" value="{{ old('approved_at', $order->approved_at) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="rejected_at" id="rejected_at" value="{{ old('rejected_at', $order->rejected_at) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="proposed_time" id="proposed_time" value="{{ old('proposed_time', $order->proposed_time) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="request_note" id="request_note" value="{{ old('request_note', $order->request_note) }}">
