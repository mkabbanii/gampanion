                    ...
                    <form method="POST" action="{{ route("frontend.users.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\User::IS_ACTIVE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="is_active_{{ $key }}" name="is_active" value="{{ $key }}" {{ old('is_active', '0') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\User::IS_BLOCKED_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="is_blocked_{{ $key }}" name="is_blocked" value="{{ $key }}" {{ old('is_blocked', '0') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\User::IS_PROVIDER_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="is_provider_{{ $key }}" name="is_provider" value="{{ $key }}" {{ old('is_provider', '0') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            @if($errors->has('become_provider_at'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('become_provider_at') }}
                                </div>
                            @endif
