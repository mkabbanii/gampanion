        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.gampanion.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.gampanions.update", [$gampanion->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="game_id" id="game_id" required>
                                @foreach($games as $id => $game)
                                    <option value="{{ $id }}" {{ (old('game_id') ? old('game_id') : $gampanion->game->id ?? '') == $id ? 'selected' : '' }}>{{ $game }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('game'))
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="user_id" id="user_id" required>
                                @foreach($users as $id => $user)
                                    <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $gampanion->user->id ?? '') == $id ? 'selected' : '' }}>{{ $user }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('user'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cost" id="cost" value="{{ old('cost', $gampanion->cost) }}" step="1" required>
                            @if($errors->has('cost'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cost') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="level" id="level" value="{{ old('level', $gampanion->level) }}">
                            @if($errors->has('level'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('level') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="server" id="server" value="{{ old('server', $gampanion->server) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="platform" id="platform" value="{{ old('platform', $gampanion->platform) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="availability" id="availability" value="1" {{ $gampanion->availability || old('availability', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="discount" id="discount" value="{{ old('discount', $gampanion->discount) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="other_game" id="other_game" value="{{ old('other_game', $gampanion->other_game) }}">
