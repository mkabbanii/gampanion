        ...
        <div class="col-md-12">
            @can('gampanion_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.gampanions.create') }}">
                            ...
                            <tbody>
                                @foreach($gampanions as $key => $gampanion)
                                    <tr data-entry-id="{{ $gampanion->id }}">
                                        ...
                                        <td>
                                            @can('gampanion_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.gampanions.show', $gampanion->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('gampanion_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.gampanions.edit', $gampanion->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('gampanion_delete')
                                                <form action="{{ route('frontend.gampanions.destroy', $gampanion->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('gampanion_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.gampanions.massDestroy') }}",
