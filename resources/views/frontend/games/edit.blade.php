                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.games.update", [$game->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="game_name" id="game_name" value="{{ old('game_name', $game->game_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="game_info" id="game_info" value="{{ old('game_info', $game->game_info) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="note" id="note" value="{{ old('note', $game->note) }}">
                            @if($errors->has('note'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('note') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="is_featured" id="is_featured" value="{{ old('is_featured', $game->is_featured) }}" step="1">
